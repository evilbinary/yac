...
anf_case "lambda" 'fun (a) -> a + 1' '[[[letfun, t1, [a], [[[letbin, t0, +, [var, a], [int, 1]]], [var, t0]]]], [var, t1]]'
...
anf_case "recursive fun" 'let f(n) = if n == 0 then 0 else f(n - 1)' '[[[letfun, f, [n], [[[letbin, t0, ==, [var, n], [int, 0]], [letif, t3, [var, t0], [[], [int, 0]], [[[letbin, t1, -, [var, n], [int, 1]], [letcall, t2, [var, f], [[var, t1]]]], [var, t2]]]], [var, t3]]]], [unit]]'
anf_case "curried closure" 'let y = fun (a) -> fun (b) -> a + b in y(1)' '[[[letfun, y, [a], [[[letfun, t1, [b], [[[letbin, t0, +, [var, a], [var, b]]], [var, t0]]]], [var, t1]]], [letcall, t2, [var, y], [[int, 1]]]], [var, t2]]'
