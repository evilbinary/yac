...
YC_SRCS = src-self/lib/log.yac src-self/lib/pass.yac src-self/lib/map.yac \
	...
	src-self/back/pack/target.yac src-self/back/pack/dlib.yac src-self/back/pack/elf.yac src-self/back/pack/pe.yac src-self/back/pack/macho.yac src-self/back/pack/yjit.yac src-self/back/pack/pack.yac \
